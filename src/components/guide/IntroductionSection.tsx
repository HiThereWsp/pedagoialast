...
export function IntroductionSection() {
  return <section id="introduction" className="space-y-8" itemScope itemType="https://schema.org/Article">
      ...
      <h2 className="text-3xl font-bold text-[#2c3e50] border-b border-gray-100 pb-4">Dites adieu à la surcharge de travail !</h2>

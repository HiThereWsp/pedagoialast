    ...
    >
      <div className="h-64 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
          ...
          <div className="w-12 h-0.5 bg-white/70 mb-3 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
          <p className="text-sm text-white/90 line-clamp-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            {description}
          </p>
        </div>

        {isNew && (
          <div className="absolute top-4 right-4 bg-white/90 px-3 py-1 rounded-full text-xs font-semibold text-blue-800 shadow-md">
            Nouveau
          </div>
        )}
      </div>
      <CardContent className="p-6 flex justify-center">
        <Button
          variant="default"
          size="icon"
          className="rounded-full w-12 h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-md group-hover:shadow-lg transition-all duration-300"
        >
    ...
    >
      <div className="h-44 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-4">
          <div className="flex justify-between items-start">
            <div className="relative z-10 text-white opacity-0 group-hover:opacity-100 transform scale-90 group-hover:scale-100 transition-all bg-white/20 backdrop-blur-sm p-3 rounded-full">
              {icon}
            </div>
          ...
          <div className="text-white">
            <h3 className="text-xl font-bold group-hover:translate-y-0 translate-y-1 transition-transform duration-300">
              {title}
            </h3>
            <p className="text-sm text-white/90 mt-2 line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              {description}
            </p>
          </div>
        </div>
      ...
      <CardContent className="p-5 flex justify-center">
        {buttonText ? (
          <Button
            variant="outline"
            className="w-full border border-gray-200 text-blue-600 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 group-hover:bg-blue-50 transition-all duration-300"
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="rounded-full w-10 h-10 border border-gray-200 text-blue-600 hover:bg-blue-50 hover:text-blue-700 hover:border-gray-200 transition-all duration-300"
          >

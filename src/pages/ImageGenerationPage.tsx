    ...
    <>
      ...
      <div className="container mx-auto py-8">
        ...
        <div className="text-center mb-12">
          <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-search-light to-search-accent/20 flex items-center justify-center">
            <Image className="w-10 h-10 text-search-accent animate-pulse" />
          </div>

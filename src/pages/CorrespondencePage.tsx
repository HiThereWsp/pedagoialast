...
export default function CorrespondencePage() {
  return <>
      <SEO title="Générateur de correspondances | PedagoIA - Communications professionnelles" description="Créez des correspondances professionnelles pour communiquer efficacement avec les parents d'élèves, la direction et vos collègues." />
      <div className="container mx-auto py-8">
        <Link to="/home" className="block mb-8">
          <img src="/lovable-uploads/03e0c631-6214-4562-af65-219e8210fdf1.png" alt="PedagoIA Logo" className="w-[100px] h-[120px] object-contain mx-auto" />
        </Link>
